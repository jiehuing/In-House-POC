    ...
    <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td class="auto-style1">Option:</td>
            ...
            <tr>
                <td class="auto-style31">&nbsp;</td>
                <td class="auto-style15">Region:</td>
                <td class="auto-style25">
...
&nbsp;<asp:DropDownList ID="DropDownList3" runat="server">
                ...
                &nbsp;<asp:Button ID="btnGTD" runat="server" OnClick="btnGTD_Click" Text="Go to date" />
                </td>
                <td class="auto-style29">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style9">
                    <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" BackColor="White" BorderColor="Black" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="250px" Width="330px" NextPrevFormat="ShortMonth" BorderStyle="Solid" CellSpacing="1">
            ...
            <tr>
                ...
                <td class="auto-style28">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit" CssClass="auto-style27" Height="30px" Width="70px" />
                </td>
                <td class="auto-style29">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
